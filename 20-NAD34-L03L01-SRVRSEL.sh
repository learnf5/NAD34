...
# curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/NAD34/main/lab01/hosts
# sudo cp /tmp/hosts                                  /etc/hosts

# update nginx host for the specific lab
curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/NAD34/main/lab03/hosts
sudo scp /tmp/hosts    nginx:/etc/hosts

#Remove default.conf file since this lab requires only default.bak
sudo ssh nginx rm /etc/nginx/conf.d/default.conf

curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/NAD34/main/lab03/default.bak
...
curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/NAD34/main/lab03/index.html
sudo scp /tmp/index.html                          nginx:/etc/nginx/html/

#Copy example1.html and example3.html to /etc/nginx/html
curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/NAD34/main/lab03/example{1,2,3,4}.html
...
#curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/NAD34/main/lab03/mywebserver.bak
