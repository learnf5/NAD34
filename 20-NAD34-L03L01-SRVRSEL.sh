...
curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/$COURSE_ID/main/lab03/hosts
...
curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/$COURSE_ID/main/lab03/index.html
sudo scp /tmp/index.html                          nginx:/etc/nginx/html/

#Copy example1.html and example3.html to /etc/nginx/html
curl --silent --remote-name-all --output-dir /tmp https://raw.githubusercontent.com/learnf5/$COURSE_ID/main/lab03/example{1,2,3,4}.html
